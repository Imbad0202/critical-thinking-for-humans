...
flowchart TD
    ...
    Canonical -->|"build_claude_ai_zip.sh<br/>+ platforms/claude-ai/ overlays"| Zip["claude.ai zip<br/>same modes & redlines;<br/>23 expedition packs included;<br/>passport → copy-paste block<br/>(no local filesystem)"]
