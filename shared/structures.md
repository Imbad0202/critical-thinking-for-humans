...
Scene's **fallacy-recognition track** (modes/scene.md) uses these eleven lenses,
and the eleven are the complete ruling surface — a fallacy named outside them is
