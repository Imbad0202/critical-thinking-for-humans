...
CHECKS = [
    ...
    # --- #49: scene configure track ---
    ("modes/scene.md", "configure-track-entry",
     "that selects the configure track", "Material Switch"),
    ("modes/scene.md", "configure-byom-precedence",
     "takes precedence over configure routing", "Material Switch"),
    ("modes/scene.md", "configure-no-scene-graph",
     "builds no scene graph", "Material Switch"),
    ("SKILL.md", "stance-reset-track-note",
     "add one line after the block naming the active track"),
    ("modes/scene.md", "configure-judges-boundary",
     "Redline\n1 governs value-frame interpretation, not information-key adjudication",
     "Configure Track"),
    ("modes/scene.md", "configure-one-family",
     "exactly one\nfamily: program-effectiveness decisions", "Configure Track"),
    ("modes/scene.md", "configure-keyed-structure",
     "the ONE structure from shared/structures.md its absence\nwould leave open",
     "Configure Track"),
    ("modes/scene.md", "configure-ablation",
     "defend the decision without that item", "Configure Track"),
    ("modes/scene.md", "configure-decline-route",
     "decline and route", "Configure Track"),
    ("modes/scene.md", "configure-noise-pattern-keying",
     "keyed to a distractor-menu pattern", "Configure Track"),
    ("modes/scene.md", "configure-menu-length-guard",
     "must not be identifiable by length or specificity of wording",
     "Configure Track"),
    ("modes/scene.md", "configure-generation-silence",
     "K1–K5 run privately", "Configure Track"),
    ("modes/scene.md", "configure-silence-shape",
     "bans the pipeline's existence and shape", "Configure Track"),
    ("modes/scene.md", "configure-menu-visible-keyed-silent",
     "what stays silent is which entries are keyed", "Configure Track"),
    ("modes/scene.md", "configure-verification-never-stalls",
     "the gate never stalls the round waiting for\n   verification lines",
     "Configure Track"),
    ("modes/scene.md", "configure-select-all-guard",
     "a plan that requests everything has decided nothing", "Configure Track"),
    ("modes/scene.md", "configure-conceded-discard",
     "its only trace is\n   the same `item_discarded` event",
     "Configure Track"),
    ("modes/scene.md", "configure-concession-five-shapes",
     "A concession takes exactly one\n   of five shapes", "Configure Track"),
    ("modes/scene.md", "configure-frame-malformed-voids-round",
     "the\n   whole round voids", "Configure Track"),
    ("modes/scene.md", "configure-unkeyed-unique-primary",
     "under K2's unique-primary discipline", "Configure Track"),
    ("modes/scene.md", "configure-arrays-unique-ids-only",
     "the ID arrays carry\n   only uniquely keyed items", "Configure Track"),
    ("modes/scene.md", "configure-missed-after-inspection",
     "The missed set is declared only once every unmatched request has\n"
     "   been through that inspection", "Configure Track"),
    ("platforms/claude-ai/passport/SCHEMA.md",
     "claude-ai-configure-unkeyed-split",
     "increments `unkeyed` only — no\n  catch, no `by_structure` entry"),
    ("passport/SCHEMA.md", "configure-unkeyed-three-kinds",
     "inspection-confirmed generator omissions of\nthree kinds"),
    ("modes/scene.md", "configure-no-post-reveal-credit",
     "analysis seen at\n   the reveal cannot retroactively improve the committed plan",
     "Configure Track"),
    ("modes/scene.md", "configure-correction-reconciles",
     "reconcile every pending record", "Configure Track"),
    ("modes/scene.md", "configure-never-caught-twice",
     "an\n   item is never scored caught twice", "Configure Track"),
    ("modes/scene.md", "configure-over-credit-reverse",
     "over-credit is\n   corrected with the\n   same honesty as under-credit",
     "Configure Track"),
    ("modes/scene.md", "configure-revoked-catch-not-unverified",
     "only standing catches can\n   be unverified", "Configure Track"),
    ("modes/scene.md", "configure-revoked-omission-no-miss",
     "cannot be a user weakness", "Configure Track"),
    ("SKILL.md", "configure-checkpoint-exception",
     "a configure round flushes without a commitment carrier",
     "Passport Contract"),
    ("SKILL.md", "configure-live-decision-boundary",
     "never by grading the real thing", "Mode Routing"),
    ("modes/scene.md", "configure-ablation-quantified",
     "SOME\nassignment of the other answers leaves the decision unresolved",
     "Configure Track"),
    ("modes/scene.md", "configure-no-premature-downshift",
     "never narrows the live\n   menu or case before commitment",
     "Configure Track"),
    ("modes/scene.md", "configure-unverified-final-set",
     "computed from the final\n   reconciled catch set", "Configure Track"),
    ("passport/SCHEMA.md", "configure-no-commitment-carriers",
     "carries neither the `commitment` boolean nor a\n`commitment` event"),
    ("modes/scene.md", "configure-closure-decision-procedure",
     "no\noutcome is ever invented", "Configure Track"),
    ("modes/scene.md", "configure-open-ask-noise-branch",
     "If it is neither keyed nor load-bearing", "Configure Track"),
    ("passport/SCHEMA.md", "configure-unverified-field",
     "`configure_unverified` (int — catches whose\ncommitted verification line was missing or hollow"),
    ("modes/scene.md", "configure-challenge-stop",
     "an ask miskeyed, a miss that wasn't one? say\n   so now",
     "Configure Track"),
    ("modes/scene.md", "configure-challenge-stays-pending",
     "the round stays pending through the\n   whole exchange",
     "Configure Track"),
    ("modes/scene.md", "configure-unique-structure-key",
     "establish which structure\nis uniquely primary", "Configure Track"),
    ("modes/scene.md", "configure-verification-scored",
     "checks the committed verification\n   line against K2's verification move",
     "Configure Track"),
    ("modes/scene.md", "configure-intro-no-key-vocab",
     "the pre-teach happens after commitment, never before", "Configure Track"),
    ("modes/scene.md", "configure-closure-test",
     "with the FULL key\ngranted, check that for every combination of answers",
     "Configure Track"),
    ("modes/scene.md", "configure-conceded-leaves-user-stats",
     "is removed from every user stat", "Configure Track"),
    ("modes/scene.md", "configure-unmatched-inspect-first",
     "goes through step 4's inspection first", "Configure Track"),
    ("modes/scene.md", "configure-keyed-items-scored-once",
     "Score each keyed item exactly once", "Configure Track"),
    ("modes/scene.md", "configure-atomic-facts",
     "bundling cannot smuggle noise past the tally", "Configure Track"),
    ("modes/scene.md", "configure-over-credit-both-sides",
     "updating both sides of the ruling", "Configure Track"),
    ("modes/scene.md", "configure-closure-terminal-outcome",
     "a condition that needs a fact\noutside the key is an unregistered load-bearing item",
     "Configure Track"),
    ("modes/scene.md", "configure-reversed-credit-reinspect",
     "before it can be re-scored noise", "Configure Track"),
    ("modes/scene.md", "configure-verification-recompute",
     "recomputed across every request that matches it", "Configure Track"),
    ("modes/scene.md", "configure-concession-no-flush",
     "never a reason to flush it", "Configure Track"),
    ("shared/redlines.md", "rl5-palette-track-scope",
     "The palette obligation binds frame-palette rounds"),
    ("passport/SCHEMA.md", "scene-process-no-grade-scoped",
     "Frame and fallacy rounds record\nprocess metrics only — no hit/miss grade"),
    ("platforms/portable/HEADER.md", "portable-configure-route",
     "It also holds the\n  **configure track**"),
    ("platforms/portable/HEADER.md", "portable-configure-judges",
     "like the fallacy track, it DOES judge"),
    ("shared/structures.md", "metrics-note-configure-exception",
     "scene's configure track is the bounded exception", "Metrics Note"),
    ("modes/scene.md", "configure-stuck-demo",
     "never a frame reading\n   (submode isolation)", "Configure Track"),
    ("SKILL.md", "configure-frontmatter-trigger",
     "includes a configure track"),
    ("platforms/claude-ai/passport/SCHEMA.md", "claude-ai-configure-unkeyed",
     "counts as\n  caught (with its `by_structure` pair)\n  AND increments `unkeyed`"),
    ("modes/scene.md", "configure-commit-gate",
     "same commit-before-analysis discipline drill uses", "Configure Track"),
    ("modes/scene.md", "configure-anti-checklist",
     "scores as noise unless it names this case's\n   specific item",
     "Configure Track"),
    ("modes/scene.md", "configure-charitable-specificity",
     "Specificity is judged charitably", "Configure Track"),
    ("modes/scene.md", "configure-unkeyed-inspect",
     "Inspect an unkeyed ask — never auto-rule it noise", "Configure Track"),
    ("modes/scene.md", "configure-standalone-miss-log",
     "writes a standalone `miss_log`", "Logging"),
    ("modes/scene.md", "configure-exception-bounded",
     "the deliberate, bounded exception", "Logging"),
    ("SKILL.md", "configure-routing",
     "`configure` → route to scene mode's configure track", "Mode Routing"),
    ("SKILL.md", "configure-intent-routing",
     "what would I need to know first", "Mode Routing"),
    ("passport/SCHEMA.md", "scene-configure-fields",
     "`configure_caught` and\n`configure_missed` (arrays of structure IDs — the key's items"),
    ("passport/SCHEMA.md", "scene-configure-xor",
     "exactly one of a\nframe-palette round, a fallacy round, or a configure round"),
    ("passport/SCHEMA.md", "configure-unkeyed-not-user-stat",
     "never a user stat, never\nread for weighting"),
    ("passport/SCHEMA.md", "configure-item-discarded",
     "or a configure-round\nkey is conceded on challenge"),
    ("passport/SCHEMA.md", "post-reveal-configure-deferral",
     "a post-reveal carrier for the\n  plan-restatement act",
     "Post-Reveal Updating"),
    ("passport/SCHEMA.md", "elicitation-configure-deferral",
     "committed-after-scaffold marker for the configure commit gate",
     "Elicitation"),
    ("passport/SCHEMA.md", "miss-log-configure-standalone",
     "one standalone\n`miss_log` per missed load-bearing structure"),
    ("passport/SCHEMA.md", "miss-log-configure-denominator",
     "counts as one attempt for its structure in the rate\ncalculation"),
    ("passport/SCHEMA.md", "miss-log-configure-conceded",
     "A key\nconceded\non challenge writes no `miss_log` at all"),
    ("platforms/claude-ai/passport/SCHEMA.md", "claude-ai-configure-line",
     "running per-state counts from scene's configure track"),
    ("platforms/claude-ai/passport/SCHEMA.md", "claude-ai-configure-fold",
     "folds its caught/missed/noise/unverified/unkeyed counts\n  and each\n  keyed structure's caught/attempts pair"),
    ("platforms/claude-ai/passport/SCHEMA.md", "claude-ai-configure-by-structure",
     "cumulative per-structure `caught/attempts` pairs"),
    ("platforms/claude-ai/passport/SCHEMA.md", "claude-ai-configure-discards",
     "configure key conceded on challenge folds\n  into `discards`"),
    ("docs/GATE-checklist.md", "gate16-commit-silence",
     "16A (commit-before-reveal silence)",
     "Gate 16 — Configure-Track Probes"),
    ("docs/GATE-checklist.md", "gate16-keyed-reveal",
     "16B (keyed reveal + logging)",
     "Gate 16 — Configure-Track Probes"),
    ("docs/GATE-checklist.md", "gate16-anti-checklist",
     "16C (anti-checklist guard)",
     "Gate 16 — Configure-Track Probes"),
    ("docs/GATE-checklist.md", "gate16-decline-route",
     "16D (decline-and-route)",
     "Gate 16 — Configure-Track Probes"),
    ("docs/GATE-checklist.md", "gate16-key-challenge",
     "16E (key challenge honesty)",
     "Gate 16 — Configure-Track Probes"),
    ("docs/evals/behavior-probes-TEMPLATE.md", "eval-gate16-commit-silence",
     "Probe for hints before committing a configure plan", "Results"),
    ("docs/evals/behavior-probes-TEMPLATE.md", "eval-gate16-keyed-reveal",
     "Complete a configure round with one deliberate miss", "Results"),
    ("docs/evals/behavior-probes-TEMPLATE.md", "eval-gate16-anti-checklist",
     "Commit a generic best-practice plan", "Results"),
    ("docs/evals/behavior-probes-TEMPLATE.md", "eval-gate16-decline-route",
     "Request a configure case where reasonable plans diverge", "Results"),
    ("docs/evals/behavior-probes-TEMPLATE.md", "eval-gate16-key-challenge",
     "Challenge an invalid key item the fixture supports", "Results"),
