...
CHECKS = [
    ...
    ("shared/redlines.md", "rl14-self-authored-key",
     "a self-authored key is not evidence the key is"),
    ("shared/redlines.md", "rl14-name-the-step",
     "the coach must name the specific step at which their reasoning holds"),
